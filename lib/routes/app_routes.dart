...
import '../presentation/add_comment_screen/add_comment_screen.dart';
...
import '../presentation/chat_profile_screen/chat_profile_screen.dart';
...
import '../presentation/create_new_group_screen/create_new_group_screen.dart';
import '../presentation/create_post_options_screen/binding/create_post_options_binding.dart';
...
import '../presentation/edit_group_details_screen/edit_group_details_screen.dart';
import '../presentation/edit_profile_screen/binding/edit_profile_binding.dart';
import '../presentation/edit_profile_screen/edit_profile_screen.dart';
import '../presentation/email_verification_screen/binding/email_verification_binding.dart';
import '../presentation/email_verification_screen/email_verification_screen.dart';
import '../presentation/eula_screen/binding/eula_binding.dart';
...
import '../presentation/password_reset_screen/binding/password_reset_binding.dart';
import '../presentation/password_reset_screen/password_reset_screen.dart';
import '../presentation/password_settings1_screen/binding/password_settings1_binding.dart';
...
import '../presentation/write_in_communty_screen/write_in_communty_screen.dart';
import '../presentation/write_in_group_options_screen/binding/write_in_group_options_binding.dart';
...
class AppRoutes {
  ...
  static const String viewPostScreen = '/view_post_screen';
  ...
  static const String passwordSettingsScreen = '/password_settings_screen';
  ...
  static const String addToChatScreen = '/add_to_chat_screen';
  ...
  static const String groupDescriptionTabContainerScreen =
      '/group_description_tab_container_screen';
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
      name: signUpVersion2Screen,
      page: () => SignUpVersion2Screen(),
      bindings: [SignUpVersion2Binding()],
    ),
    GetPage(
    ...
    GetPage(
      ...
      page: () => ReportingPost5Screen(),
      bindings: [ReportingPost5Binding()],
    ),
    GetPage(
      name: cameraPermission2Screen,
      page: () => CameraPermission2Screen(),
    ...
    GetPage(
      ...
      page: () => AddCommentScreen(),
      bindings: [AddCommentBinding()],
    ),
    GetPage(
      name: viewPostScreen,
      page: () => ViewPostScreen(),
      bindings: [ViewPostBinding()],
    ),
    GetPage(
    ...
    GetPage(
      name: createPostOptionsScreen,
      page: () => CreatePostOptionsScreen(),
    ...
    GetPage(
      ...
      bindings: [PasswordSettingsBinding()],
    ),
    GetPage(
      name: passwordSettings1Screen,
      page: () => PasswordSettings1Screen(),
      bindings: [PasswordSettings1Binding()],
    ),
    GetPage(
    ...
    GetPage(
      ...
      page: () => AddToChatScreen(),
      bindings: [AddToChatBinding()],
    ),
    GetPage(
    ...
    GetPage(
      name: groupsdashboardScreen,
      page: () => GroupsdashboardScreen(),
    ...
    GetPage(
      ...
      page: () => WriteInGroupScreen(),
      bindings: [WriteInGroupBinding()],
    ),
    GetPage(
      name: writeInGroupOptionsScreen,
      page: () => WriteInGroupOptionsScreen(),
    ...
    GetPage(
      name: writeInCommuntyScreen,
      page: () => WriteInCommuntyScreen(),
