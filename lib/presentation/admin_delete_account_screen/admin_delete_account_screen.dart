...
import 'controller/admin_delete_account_controller.dart'; // ignore_for_file: must_be_immutable

class AdminDeleteAccountScreen extends GetWidget<AdminDeleteAccountController> {
  const AdminDeleteAccountScreen({Key? key})
      : super(
          key: key,
        );
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20.v),
                            _buildConfirmDeleteButton(),
                            SizedBox(height: 20.v),
                            _buildCancelDeleteButton(),
  ...
  /// Section Widget
  Widget _buildCancelDeleteButton() {
    return CustomElevatedButton(
      height: 44.v,
      text: "lbl_cancel2".tr,
      margin: EdgeInsets.only(
