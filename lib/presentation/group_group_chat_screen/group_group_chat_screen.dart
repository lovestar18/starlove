...
import 'controller/group_group_chat_controller.dart'; // ignore_for_file: must_be_immutable

class GroupGroupChatScreen extends GetWidget<GroupGroupChatController> {
  const GroupGroupChatScreen({Key? key})
      : super(
          key: key,
        );
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: CustomTextStyles.bodySmallInterIndigo90002.copyWith(
                    height: 1.50,
                  ),
                ),
                Align(
