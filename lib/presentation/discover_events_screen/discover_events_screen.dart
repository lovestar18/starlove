...
import 'models/eventgrid_item_model.dart';
import 'widgets/eventgrid_item_widget.dart'; // ignore_for_file: must_be_immutable

class DiscoverEventsScreen extends GetWidget<DiscoverEventsController> {
  const DiscoverEventsScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Obx(
        () => GridView.builder(
          ...
          itemCount: controller
              .discoverEventsModelObj.value.eventgridItemList.value.length,
          itemBuilder: (context, index) {
            EventgridItemModel model = controller
                .discoverEventsModelObj.value.eventgridItemList.value[index];
            return EventgridItemWidget(
              model,
            );
          },
        ),
