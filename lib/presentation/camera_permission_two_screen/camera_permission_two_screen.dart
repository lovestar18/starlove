...
import 'controller/camera_permission_two_controller.dart'; // ignore_for_file: must_be_immutable

class CameraPermissionTwoScreen
    extends GetWidget<CameraPermissionTwoController> {
  const CameraPermissionTwoScreen({Key? key})
      : super(
          key: key,
        );
                              ...
                              children: [
                                Text(
                                  ...
                                  style: CustomTextStyles
                                      .titleMediumOpenSansOnPrimary18,
                                ),
                                SizedBox(height: 6.v),
                                Text(
