...
class CreateGroupChatModel {
  Rx<List<Userprofile1ItemModel>> userprofile1ItemList = Rx([
    Userprofile1ItemModel(darlenesteward: "Darlene Steward".obs),
    Userprofile1ItemModel(darlenesteward: "Billie Anderson".obs),
    Userprofile1ItemModel(darlenesteward: "Ahmed Boustani".obs)
  ]);
}
