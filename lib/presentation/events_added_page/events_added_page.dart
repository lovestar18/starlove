...
class EventsAddedPage extends StatelessWidget {
  EventsAddedPage({Key? key})
      : super(
          key: key,
        );

  EventsAddedController controller =
      Get.put(EventsAddedController(EventsAddedModel().obs));
      ...
      child: Obx(
        () => GridView.builder(
          ...
          itemCount: controller
              .eventsAddedModelObj.value.eventdetailsItemList.value.length,
          itemBuilder: (context, index) {
            EventdetailsItemModel model = controller
                .eventsAddedModelObj.value.eventdetailsItemList.value[index];
